...
[Cheatsheet](https://awesomeclaude.ai/code-cheatsheet) [Vibe Guide](https://awesomeclaude.ai/vibe-coding-guide) [Ralph Wiggum](https://awesomeclaude.ai/ralph-wiggum)

Community

[How-To Guides](https://awesomeclaude.ai/how-to "How-To Guides")[GitHub](https://github.com/tonysurfly/awesome-claude)
...
[![Claw To Talk app screenshot showing OpenClaw Voice Companion interface](https://awesomeclaude.ai/clawtotalk.png)\\
\\
Featured\\
\\
**Claw To Talk**\\
\\
OpenClaw Voice Companion. A voice interface for Claude Code that keeps your hands on the keyboard and your flow uninterrupted. \\
\\
clawtotalk.comTry It](https://clawtotalk.com/)
...
[![Molt Founders mascot artwork for The Agent Co-Founder Network](https://awesomeclaude.ai/body.png)\\
\\
Featured\\
\\
**The Agent Co-Founder Network**\\
\\
The Agent Co-Founder Network. The infrastructure for agent-to-agent team formation. Connect, collaborate, and build autonomous SaaS products together. \\
\\
moltfounders.comExplore](https://moltfounders.com/)
...
\\
Anthropic-managed Claude Code plugins](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/ralph-loop) [**Geoffrey Huntley's Blog** \\
\\
Original technique creator and philosophy](https://ghuntley.com/ralph/) [**Ralph Orchestrator** \\
\\
Community tool for managing Ralph loops](https://github.com/mikeyobrien/ralph-orchestrator)

![Awesome Claude Logo](https://awesomeclaude.ai/awesomeclaude.svg)

### Awesome Claude

Curated collection of the best Claude AI tools, integrations, and resources for developers.

[View project on GitHub](https://github.com/tonysurfly/awesome-claude)[Fork project on GitHub](https://github.com/tonysurfly/awesome-claude/fork)

### Quick Links

[Awesome List](https://awesomeclaude.ai/) [Code Cheatsheet](https://awesomeclaude.ai/code-cheatsheet) [Awesome Claude Code](https://awesomeclaude.ai/awesome-claude-code)

### Contribute

[Report Issues](https://github.com/tonysurfly/awesome-claude/issues/new) [Submit PR](https://github.com/tonysurfly/awesome-claude/pulls) [Contributing Guide](https://github.com/tonysurfly/awesome-claude/blob/main/CONTRIBUTING.md)

Found something awesome?

[Add it to the list](https://github.com/tonysurfly/awesome-claude/fork)

[![html2png.dev](https://awesomeclaude.ai/bdd/html2png.svg)Html2png](https://html2png.dev/) [![GitDB](https://awesomeclaude.ai/bdd/gitdb.svg)GitDB](https://gitdb.net/) [![FreeSubStats](https://awesomeclaude.ai/bdd/freesubstats.svg)FreeSubStats](https://freesubstats.com/) [![OMOS](https://awesomeclaude.ai/bdd/omos.png)oh-my-opencode-slim](https://ohmyopencodeslim.com/) [🦀Craber News](http://crabernews.com/)

© 2026 Awesome Claude• [MIT License](https://github.com/tonysurfly/awesome-claude/blob/main/LICENSE)
